...
export default function ModelsPage() {
  ...
  {/* Page Hero Section */}
  <section className="pt-[12rem] pb-16 bg-gradient-to-b from-white to-white">
        <div className="max-w-1280px mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl font-bold text-black mb-6">
